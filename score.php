...
//CORRECT ANSWERS
$correct = select("SELECT * FROM objans WHERE score !='0' AND studentID='$studentID'");
$numcorrect = count($correct);
$correctMarks = $numcorrect * $testrow['questionMark'];

//WRONG ANSWERS
$wrong = select("SELECT * FROM objans WHERE score ='0' AND studentID='$studentID'");
                ...
                <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" onclick="return confirm('FINISH TEST.');" name="finish" class="btn btn-primary btn-block">
                                  FINISH <i class="fe fe-file-text"></i>
                                </button>
                            </div>
                        </div>
                    </div>
